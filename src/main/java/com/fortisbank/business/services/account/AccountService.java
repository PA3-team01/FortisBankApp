package com.fortisbank.business.services.account;
 ...
 public class AccountService implements IAccountService {
     ...
     /**
      * Returns the singleton instance of AccountService for the given storage mode.
      *
      * @param storageMode the storage mode
     ...
     /**
      * Automatically closes inactive currency accounts that have been inactive for over a year.
      */
     ...
     /**
      * Checks for accounts with low balance and sends notifications if the balance is below the threshold.
      */
